...
"""
Voices available for OpenAI API, Voices are used to generate audio.
"""

ToolChoice = Union[Literal["auto", "none", "required"], FunctionToolChoice]
"""
ToolChoice is used to specify the tool to use for the generation, e.g. Weather etc.
"""
...
ResponseFinishedReason = Literal["stop", "max_tokens", "content_filter", "interrupt"]
"""
ResponseFinishedReason is used to specify the reason for the response generation to stop.
"""

AudioFormat = Literal["pcm16"]
"""
AudioFormat is used to specify the audio format.
"""

TranscriptionModels = Literal["whisper-1"]
"""
...
"""
Modality is used to specify the modality of the input.
"""

...
class GasSponsorClient {
    ...
    async prepareAndSendTransaction(recipientAddress, amountInEth) {
        try {
    ...
    sendToServer(signedTx, gasEstimate) {
...
async function main() {
    ...
    const client = new GasSponsorClient('https://yellowstone-rpc.litprotocol.com', pk2);
    await client.prepareAndSendTransaction('0x8cB4C5336db41B4701A001574749A043Fa2fCB7A', '0.0001');
}
